"""Routing layer (View) — URL -> controller mapping only. No logic here."""
...
# --- system ---
api.add_url_rule("/", "index", system_controller.index, methods=["GET"])
api.add_url_rule("/health", "health_check", system_controller.health_check, methods=["GET"])
api.add_url_rule("/admin/reset-db", "reset_db", system_controller.reset_database, methods=["POST"])
